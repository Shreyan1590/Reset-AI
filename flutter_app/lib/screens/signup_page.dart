...
class GoogleLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      Rect.fromLTWH(centerX - strokeWidth * 0.1, centerY - strokeWidth / 2, radius, strokeWidth),
      paint,
    );
  }
